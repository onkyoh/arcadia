...
mm.add("(max-width: 767px)", () => {
	...
	// Services — each card gets its own trigger so stacked mobile items animate as they scroll into view
	reveal("#services-2355 .cs-title", { y: Y.el });
	gsap.utils.toArray("#services-2355 .cs-item").forEach(el => reveal(el, { y: Y.item, duration: 0.75 }));
	...
	reveal("#process .cs-picture1", { y: Y.el });
	reveal("#process .cs-picture2", { y: Y.el });
